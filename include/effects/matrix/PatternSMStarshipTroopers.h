...
// ... (start of private section matches) ...
    ...
    static constexpr int CHANCE = 2048;
  ...
  public:
    ...
    void Draw() override
    {
        ...
        case 0: // Up
            ...
            {
                if (x > WIDTH / 2 && random(CHANCE) < DIR_CHARGE)
                {
                    count++;
                    break;
                }
        ...
        case 1: // Up - Right
            ...
            {
                if ((int)x > WIDTH / 2 && random(CHANCE) < DIR_CHARGE)
                {
                    count++;
                    break;
                }
        ...
        case 6: // Left
            for (float x = WIDTH - 1; x > 0; x -= speedFactor)
            {
                if ((uint8_t)x < WIDTH / 2 && random(CHANCE) < DIR_CHARGE)
                {
                    count++;
                    break;
                }
